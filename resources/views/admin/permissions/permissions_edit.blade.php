            ...
            <div class="portlet light portlet-fit portlet-form bordered">
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject font-green sbold uppercase">编辑用户权限</span>
                    </div>
                </div>
                    ...
                    <form action="{{ url("admin/permissions/$permission->id") }}" class="form-horizontal" method="post">
                        ...
                        <div class="form-body">
                            <div class="form-group form-md-line-input @if($errors->has('name')) has-error @endif">
                                ...
                                <div class="col-md-9">
                                    <input type="text" class="form-control" placeholder="" name="name" id="name" value="{{ $permission->name }}">
                            ...
                            <div class="form-group form-md-line-input @if($errors->has('display_name')) has-error @endif">
                                ...
                                <div class="col-md-9">
                                    <input type="text" class="form-control" placeholder="" name="display_name" id="display_name" value="{{ $permission->display_name }}">
                                    <div class="form-control-focus"> </div>
                            ...
                            <div class="form-group form-md-line-input @if($errors->has('description')) has-error @endif">
                                ...
                                <div class="col-md-9">
                                    <textarea class="form-control" name="description" id="description" rows="3" style="margin-top: 0px; margin-bottom: 0px; height: 100px;">{{ $permission->description }}</textarea>
                                    <div class="form-control-focus"> </div>
                            ...
                            <div class="form-group form-md-line-input @if($errors->has('uri')) has-error @endif">
                                ...
                                <div class="col-md-9">
                                    <input type="text" class="form-control" placeholder="" name="uri" id="uri" value="{{ $permission->uri }}">
                                    <div class="form-control-focus"> </div>
                        ...
                        <div class="form-actions">
                            <div class="row">
                                <div class="col-md-offset-3 col-md-9">
                                    <input type="submit" class="btn green" value="更新权限">
                                </div>
                            </div>
                        </div>
                    </form>
