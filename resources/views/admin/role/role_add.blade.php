            ...
            <div class="portlet light portlet-fit portlet-form bordered">
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject font-green sbold uppercase">添加用户组</span>
                    </div>
                </div>
                <div class="portlet-body">
                    <!-- BEGIN FORM-->
                    <form action="{{ url('admin/role') }}" class="form-horizontal" method="post" >
                        {{ csrf_field() }}
                        <div class="form-body">
                            <div class="form-group form-md-line-input @if($errors->has('name')) has-error @endif">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <span class="help-block">{{ $errors->has('name') ? $errors->first('name') : '角色的唯一英文标识，创建后不可修改' }}</span>
                                </div>
                            </div>
                                            ...
                                            <div class="portlet-body">
                                                <div class="table-scrollable table-scrollable-borderless">
                                                    <table class="table table-hover table-light">
                                                        ...
                                                        <tbody>
                                                        {!! $rolePermissions->getPermissions($permissions) !!}
                                                        </tbody>
                                                    </table>
                                                </div>
                                            </div>
                        ...
                        <div class="form-actions">
                            <div class="row">
                                <div class="col-md-offset-5 col-md-7">
                                    <input type="submit" class="btn green" value="添加角色">
                                </div>
                            </div>
                        </div>
                    </form>
