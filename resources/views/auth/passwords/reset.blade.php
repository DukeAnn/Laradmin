            ...
            <div class="login-content">
                ...
                <form action="{{ url('password/reset') }}" class="login-form" method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-8">
                            <input class="form-control form-control-solid placeholder-no-fix form-group{{ $errors->has('email') ? ' has-error' : '' }}" type="email" autocomplete="off" placeholder="{{ $errors->has('email') ? $errors->first('email') : '邮箱地址' }}" name="email" required value=""/>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-2"></div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-8 text-right">
                            <button class="btn blue" type="submit">重置</button>
                        </div>
                    </div>
                </form>
            </div>
